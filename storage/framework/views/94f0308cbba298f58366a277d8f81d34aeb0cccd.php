                  ...
                  <div class="modal-body">
                    ...
                    <form id="newOrgForm" class="row g-3" method="post">
                      ...
                      <div class="col-12 col-md-6">
                        ...
                        <input type="text" id="name" name="name" class="form-control" placeholder="Forbes" value="<?php echo e(old('name')); ?>"/>
                      </div>
                      <div class="col-12 col-md-6">
                  ...
                  <div class="modal-body">
                    ...
                    <form id="newOrgForm" class="row g-3" method="post">
                      ...
                      <div class="col-12 col-md-6">
                        ...
                        <input type="text" id="updateName" name="name" class="form-control" placeholder="Forbes" value="<?php echo e(old('name')); ?>"/>
                      </div>
                      <div class="col-12 col-md-6">
                        <label class="form-label" for="updateTin">TIN</label>
                        <input type="text" id="updateTin" name="tin" class="form-control number-mask" placeholder="xxx xxx xxxx"  value="<?php echo e(old('tin')); ?>"/>
                      </div>
                      <div class="col-12 col-md-6">
                      ...
                      <div class="col-12 col-md-6">
                        ...
                        <div class="input-group">
                          <span class="input-group-text">RW (+250)</span>
                          <input type="text" id="updatePhone" name="phone" class="form-control number-mask" maxLength="10" placeholder="xxx xxx xxxx"  value="<?php echo e(old('phone')); ?>"/>
                        </div>
                      </div>
                      <div class="col-12 col-md-6">
                      ...
                      <div class="col-12 col-md-12">
                        ...
                        <input type="text" id="updateAddress" name="address" class="form-control" placeholder="Physical Address" value="<?php echo e(old('address')); ?>"/>
                      </div>
                      <div class="col-12 text-center">
                        <button type="submit" class="btn btn-primary me-sm-3 me-1">Submit</button>
                        <button type="reset" class="btn btn-label-secondary" data-bs-dismiss="modal" aria-label="Close">Cancel</button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\admin\Desktop\Lewis\rba\resources\views/users/organization.blade.php ENDPATH**/ ?>