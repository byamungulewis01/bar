              ...
              <div class=" text-body card bg-transparent shadow-none my-2">
                <div class="card-body p-0">
                  ...
                  <a href="<?php echo e(route('result', $user->id)); ?>" class="mb-3 text-body">
                    based in <?php echo e($user->district); ?> distict, <?php echo e($user->name); ?> have roll number of <?php echo e($user->regNumber); ?> and was admitted on 12/12/2012... more 
                  ...
                  <div class="d-flex align-items-center pt-1">
                    <div class="ms-auto">
                      ...
                      <a href="javascript:;" class="me-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tooltip-dark" data-bs-original-title="<?php echo e($area->law->description); ?>"><span class="badge bg-label-dark"><?php echo e($area->law->title); ?></span></a>
...
<?php /**PATH C:\xampp\htdocs\bar\resources\views/search/result.blade.php ENDPATH**/ ?>