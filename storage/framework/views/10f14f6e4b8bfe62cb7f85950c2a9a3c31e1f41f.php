                    ...
                    <div class="d-flex align-items-start justify-content-between">
                      <div class="content-left">
                        ...
                        <div class="d-flex align-items-center my-1">
                          <h4 class="mb-0 me-2"><?php echo e($allUsers); ?></h4>
                        </div>
                      </div>
                  ...
                  <div class="modal-body">
                    ...
                    <form id="newUserForm" class="row g-3" method="post"  enctype="multipart/form-data">
                      ...
                      <div class="col-12 col-md-6">
                        ...
                        <select id="marital" name="marital" class="form-select" aria-label="Default select example">
                      ...
                      <div class="col-12 col-md-4">
                        ...
                        <select id="category" name="status" class="form-select" aria-label="Default select example">
                          <option value="" selected> - Select - </option>
                      ...
                      <div class="col-12 col-md-4">
                        ...
                        <select id="practicing" name="practicing" class="form-select" aria-label="Default select example">
                          <option value="" selected> - Select - </option>
                      ...
                      <div class="col-12 col-md-4">
                        ...
                        <select id="admission" name="status" class="form-select" aria-label="Default select example">
                          <option value="" selected> - Select - </option>
                          <option <?php if(old('category')=="1"): ?> selected <?php endif; ?> value="1">Advocate</option>
                          <option <?php if(old('category')=="2"): ?> selected <?php endif; ?> value="2">Intern Advocate</option>
                          <option <?php if(old('category')=="3"): ?> selected <?php endif; ?> value="3">Support Staff</option>
                  ...
                  <div class="modal-body">
                    ...
                    <form id="editUserForm" class="row g-3 needs-validation <?php if($errors->any()): ?> validated <?php endif; ?>" novalidate="" method="post"  enctype="multipart/form-data">
                      ...
                      <div class="col-12 col-md-6">
                        ...
                        <select id="updateGender" name="gender" class="form-select" aria-label="Default select example">
                          <option value="" selected> - Select - </option>
                          <option <?php if(old('gender')=="Male"): ?> selected <?php endif; ?> value="Male">Male</option>
                          <option <?php if(old('gender')=="Male"): ?> selected <?php endif; ?> value="Female">Female</option>
                        </select>
                      ...
                      <div class="col-12 col-md-6">
                        ...
                        <select id="updateMarital" name="marital" class="form-select" aria-label="Default select example">
                          <option value="">Select</option>
                          <?php $__currentLoopData = $marital; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option <?php if(old('marital')==$status->id): ?> selected <?php endif; ?> value="<?php echo e($status->id); ?>"><?php echo e($status->title); ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <div class="col-12 col-md-6">
                        <label class="form-label" for="updateCategory">User Category</label>
                        <select id="updateCategory" name="category" class="form-select" aria-label="Default select example">
                          <option value="" selected> - Select - </option>
                          <option <?php if(old('category')=="1"): ?> selected <?php endif; ?> value="1">Advocate</option>
                          <option <?php if(old('category')=="2"): ?> selected <?php endif; ?> value="2">Intern Advocate</option>
                          <option <?php if(old('category')=="3"): ?> selected <?php endif; ?> value="3">Support Staff</option>
                      ...
                      <div class="col-12 col-md-6">
                        ...
                        <select id="updatePracticing" name="practicing" class="form-select" aria-label="Default select example">
                          <option value="" selected> - Select - </option>
                          <option <?php if(old('practicing')=="2"): ?> selected <?php endif; ?> value="2">Active</option>
                          <option <?php if(old('practicing')=="3"): ?> selected <?php endif; ?> value="3">Inactive</option>
                          <option <?php if(old('practicing')=="4"): ?> selected <?php endif; ?> value="4">Suspended</option>
        ...
        columnDefs:[
            ...
            },
            {
                ...
                },
                {
                    ...
                    orderable:!1,
                    render:function(e,t,a,s){
                        return'<div class="d-flex align-items-center"><a href="javascript:;" class="text-body edit-record "><i class="ti ti-edit ti-sm me-2" data-id="'+a.id+'" data-name="'+a.name+'" data-photo="'+a.photo+'" data-diplome="'+a.diplome+'" data-phone="'+a.phone[0].phone+'" data-email="'+a.email+'" data-district="'+a.district+'" data-gender="'+a.gender+'" data-marital="'+a.marital+'" data-regNumber="'+a.regNumber+'" data-status="'+a.status+'" data-practicing="'+a.practicing+'" data-category="'+a.category+'"></i></a><a href="'+r+a.id+'" class="text-body"><i class="ti ti-eye ti-sm mx-2"></i></a><a href="javascript:;" class="text-body delete-record '+a.id+'"><i class="ti ti-trash ti-sm mx-2"></i></a></div></div>'
                    }
                }
            ],
            order:[
