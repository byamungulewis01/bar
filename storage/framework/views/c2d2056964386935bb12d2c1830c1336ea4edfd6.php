                ...
                <div class="card-body p-0">
                  <div class="d-flex align-items-center mb-3">
                    <a href="<?php echo e(route('result', $user->id)); ?>" class="d-flex align-items-center">
                      <div class="avatar me-2">
                        <img src="<?php echo e(asset('assets/img/avatars/')); ?>/<?php echo e($user->user->photo); ?>" alt="Avatar" class="rounded">
                      </div>
                      <div class="me-2 text-body ms-1">
                        <h5 class="mb-0"><?php echo e($user->user->name); ?></h5>
                        <div class="client-info"><strong>Status: </strong><span class="badge bg-<?php echo e(badge($user->user->practicing)); ?>"><?php echo e(userStatus($user->user->practicing)); ?></span></div>
                      </div>
                    </a>
                  </div>
                  <a href="<?php echo e(route('result', $user->user->id)); ?>" class="mb-3 text-body">
                    based in <?php echo e($user->user->district); ?> distict, <?php echo e($user->user->name); ?> have roll number of <?php echo e($user->user->regNumber); ?> and was admitted on <?php echo e($user->user->date->format('d/m/Y')); ?>  click to view more
                  ...
                  <div class="d-flex align-items-center pt-1">
                    <div class="ms-auto">
                      ...
                      <a href="javascript:;" class="me-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tooltip-dark" data-bs-original-title="<?php echo e($user->laws->description); ?>"><span class="badge bg-label-dark"><?php echo e($user->laws->title); ?></span></a>
      ...
      $(".prefetch").typeahead(
        ...
        },
        {
          ...
          source:new Bloodhound({
            ...
            prefetch:"http://localhost:8000/api/search"
          })
        }
      )
    });
...
<?php /**PATH C:\Users\admin\Desktop\Lewis\rba\resources\views/search/category.blade.php ENDPATH**/ ?>