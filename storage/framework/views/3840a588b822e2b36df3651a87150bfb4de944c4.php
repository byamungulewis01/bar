...
<div class="row">
    <div class="col-md-12">
      <ul class="nav nav-pills flex-column flex-sm-row mb-4">
        ...
        <li class="nav-item"><a class="nav-link <?php echo e(Request::routeIs('myprobono') ? 'active' : ''); ?>" href="<?php echo e(route('myprobono')); ?>"><i class='ti-xs ti ti-gavel me-1'></i> Pro Bono Publico</a></li>
      </ul>
    </div>
  </div>
