              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td colspan="7"><h6><span class="badge bg-label-warning me-2">Warning </span>
                        ...
                        <a href="" data-bs-toggle="modal" data-bs-target="#delete<?php echo e($training->id); ?>" class="pull-left float-end"><i class="ti ti-trash me-0 me-sm-1 ti-xs text-danger"></i><span
                            class="d-none d-sm-inline-block"></span></a>
                      </h6>

                      <div class="modal modal-top fade" id="delete<?php echo e($training->id); ?>" tabindex="-1" aria-hidden="true">
