...
<div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="d-flex align-items-start justify-content-between">
                      <div class="content-left">
                        ...
                        <div class="d-flex align-items-center my-1">
                          <h4 class="mb-0 me-2"><?php echo e($users->count()); ?></h4>
                        </div>
                      </div>
            ...
            <div class="card">
              <div class="card-header border-bottom">
                <h5 class="card-title mb-0">Users <a class="btn btn-dark text-white pull-left float-end" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddUser"><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Add New User</span></a></h5>
                ...
                <div class="offcanvas-body mx-0 flex-grow-0 pt-0 h-100">
                  <form class="pt-0 needs-validation" novalidate="" method="POST">
                    ...
                    <div class="mb-3">
                      ...
                      <select id="marital" class="form-select" name="martialrequired ">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/k20/Documents/Projects/Laravel/rba/resources/views/users/individual.blade.php ENDPATH**/ ?>