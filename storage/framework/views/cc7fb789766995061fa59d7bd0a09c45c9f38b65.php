...
$(function(){
    ...
    n.length&&(e=n.DataTable({
        ...
        $(".datatables-users tbody").on("click",".delete-record",function(event){
            ...
            Swal.fire({
              title:"Are you sure?",
              text:"This user will be activated automatically!",
              icon:"warning",
              showCancelButton:!0,
              ...
              showLoaderOnConfirm: true,
              preConfirm: () => {
                return fetch('/api/users/inactive/'+id,  {
                    method: 'PUT'
                  })
                  .then(response => {
                    if (!response.ok) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rba\resources\views/users/inactive.blade.php ENDPATH**/ ?>