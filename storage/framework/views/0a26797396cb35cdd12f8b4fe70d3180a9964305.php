      ...
      <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y d-flex ">
          ...
          <form class="d-flex flex-grow-1" method="GET">
            <div class="faq-header d-flex flex-row rounded flex-grow-1" style="background: none">
              <a href="<?php echo e(route('login')); ?>" class="btn btn-dark waves-effect align-self-end waves-light" style="z-index:10">Sign In</a>
              <img src="<?php echo e(asset('assets/logo/bar-logo.png')); ?>" class="mt-1" alt="RBA Logo" height="50">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\rba\resources\views/search/result.blade.php ENDPATH**/ ?>