          ...
          <form class="d-flex flex-grow-1" method="GET">
            <div class="faq-header d-flex flex-column align-items-center rounded flex-grow-1" style="background: none">
              ...
              <img src="<?php echo e(asset('assets/logo/bar-logo.png')); ?>" class="mt-5" alt="RBA Logo" height="140">
                <?php echo csrf_field(); ?>
              <div class="input-wrapper mb-3 input-group input-group-lg input-group-merge align-self-center pt-4">
                <span class="input-group-text" id="basic-addon1"><i class="ti ti-search"></i></span>
                <input type="text" class="form-control" placeholder="" aria-label="Search" aria-describedby="basic-addon1" name="search" />
              </div>
...
<?php /**PATH /home/k20/Documents/Projects/Laravel/rba/resources/views/search.blade.php ENDPATH**/ ?>