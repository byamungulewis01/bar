...
<div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              <div class="card-header border-bottom">
                <h5 class="card-title mb-0">Users <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create-users')): ?><a class="btn btn-dark text-white pull-left float-end" data-bs-toggle="modal" data-bs-target="#newUser"><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Add New User</span></a><a class="d-none" id="edit" data-bs-toggle="modal" data-bs-target="#editUser"></a><?php endif; ?></h5>
        ...
        columnDefs:[
            ...
            },
            {
                ...
                },
                {
                    ...
                    orderable:!1,
                    render:function(e,t,a,s){
                        return'<div class="d-flex align-items-center"> <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-users')): ?><a href="javascript:;" class="text-body edit-record "><i class="ti ti-edit ti-sm me-2" data-id="'+a.id+'" data-name="'+a.name+'" data-photo="'+a.photo+'" data-diplome="'+a.diplome+'" data-phone="'+a.phone[0].phone+'" data-email="'+a.email+'" data-district="'+a.district+'" data-gender="'+a.gender+'" data-marital="'+a.marital+'" data-regNumber="'+a.regNumber+'" data-status="'+a.status+'" data-practicing="'+a.practicing+'" data-category="'+a.category+'"  data-date="'+a.date+'"></i></a><?php endif; ?> <a href="'+r+a.id+'" class="text-body"><i class="ti ti-eye ti-sm mx-2"></i></a> <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete-users')): ?><a href="javascript:;" class="text-body delete-record '+a.id+'"><i class="ti ti-trash ti-sm mx-2"></i></a><?php endif; ?></div></div>'
                    }
                }
            ],
            order:[
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rwa\resources\views/users/individual.blade.php ENDPATH**/ ?>