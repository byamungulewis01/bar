...
<div class="row">
    <div class="col-md-12">
      <ul class="nav nav-pills flex-column flex-sm-row mb-4">
        ...
        <li class="nav-item"><a class="nav-link {{ Request::routeIs('myprobono') ? 'active' : '' }} {{ Request::routeIs('probono-details') ? 'active' : '' }}" href="{{ route('myprobono') }}"><i class='ti-xs ti ti-gavel me-1'></i> Compliances</a></li>
      </ul>
    </div>
  </div>
  <!--/ Navbar pills -->