...
<div class="row">
    <div class="col-md-12">
      <ul class="nav nav-pills flex-column flex-sm-row mb-4">
        <li class="nav-item"><a class="nav-link {{ Request::routeIs('myProfile') ? 'active' : '' }}" href="{{ route('myProfile') }}"><i class='ti-xs ti ti-user-check me-1'></i> General Info</a></li>
        <li class="nav-item"><a class="nav-link {{ Request::routeIs('mydiscipline') ? 'active' : '' }}" href="{{ route('mydiscipline') }}"><i class='ti-xs ti ti-users me-1'></i> Disciplinary Records</a></li>
