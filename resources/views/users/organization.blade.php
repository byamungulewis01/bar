...
<div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              <div class="card-header border-bottom">
                <h5 class="card-title mb-0">Users Organization <a class="btn btn-dark text-white pull-left float-end" data-bs-toggle="modal" data-bs-target="#newOrg"><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Add Organization</span></a><a class="d-none" id="edit" data-bs-toggle="modal" data-bs-target="#editOrg"></a></h5>
                  ...
                  <div class="modal-body">
                    ...
                    <form id="newOrgForm" class="row g-3" method="post">
                      ...
                      <div class="col-12 col-md-6">
                        ...
                        <input type="text" id="name" name="name" class="form-control" placeholder="Forbes" value="{{ old('name') }}"/>
                      </div>
                      <div class="col-12 col-md-6">
                        <label class="form-label" for="tin">TIN</label>
                        <input type="text" id="tin" name="tin" class="form-control number-mask" placeholder="xxx xxx xxxx"  value="{{ old('tin') }}"/>
                      </div>
                      <div class="col-12 col-md-6">
                      ...
                      <div class="col-12 col-md-6">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" id="phone" name="phone" class="form-control number-mask" maxLength="10" placeholder="xxx xxx xxxx"  value="{{ old('phone') }}"/>
                        </div>
                      </div>
                      <div class="col-12 col-md-6">
                      ...
                      <div class="col-12 col-md-12">
                        ...
                        <input type="text" id="address" name="address" class="form-control" placeholder="Physical Address" value="{{ old('address') }}"/>
                      </div>
                  ...
                  <div class="modal-body">
                    ...
                    <form id="newOrgForm" class="row g-3" method="post">
                      ...
                      <div class="col-12 col-md-6">
                        ...
                        <input type="text" id="updateName" name="name" class="form-control" placeholder="Forbes" value="{{ old('name') }}"/>
                      </div>
                      <div class="col-12 col-md-6">
                        <label class="form-label" for="updateTin">TIN</label>
                        <input type="text" id="updateTin" name="tin" class="form-control number-mask" placeholder="xxx xxx xxxx"  value="{{ old('tin') }}"/>
                      </div>
                      <div class="col-12 col-md-6">
                      ...
                      <div class="col-12 col-md-6">
                        ...
                        <div class="input-group">
                          <span class="input-group-text">RW (+250)</span>
                          <input type="text" id="updatePhone" name="phone" class="form-control number-mask" maxLength="10" placeholder="xxx xxx xxxx"  value="{{ old('phone') }}"/>
                        </div>
                      </div>
                      <div class="col-12 col-md-6">
                      ...
                      <div class="col-12 col-md-12">
                        ...
                        <input type="text" id="updateAddress" name="address" class="form-control" placeholder="Physical Address" value="{{ old('address') }}"/>
                      </div>
                      <div class="col-12 text-center">
                        <button type="submit" class="btn btn-primary me-sm-3 me-1">Submit</button>
                        <button type="reset" class="btn btn-label-secondary" data-bs-dismiss="modal" aria-label="Close">Cancel</button>
...
$(function(){  
  ...
  var e,n=$(".datatables-org"),r="/profile/",oo={
      "Lawfirm":{
          title:"Lawfirm",
          class:"bg-label-info"
      },
  ...
  $(".datatables-org tbody").on("click",".delete-record",function(event){
      ...
      Swal.fire({
        ...
        preConfirm: () => {
          return fetch('/api/users/organization/'+id,  {
              method: 'DELETE',
              headers: new Headers({
...
document.addEventListener("DOMContentLoaded",function(e){
{
  ...
  @if($errors->any())
    var myModal = new bootstrap.Modal(document.getElementById('newOrg'), {
      keyboard: false
    })
    myModal.show()
  @endif
